...
const AddEmployee = () => {
    ...
    const handleSubmit = (e) => {
        ...
        formData.append('idCategory', employee.idCategory);
        ...
        <div className='p-3 rounded w-50 border'>
            ...
            <form className='row g-1' onSubmit={handleSubmit}>
                ...
                <div className='col-12'>
                    ...
                    <input type="text" className='form-control rounded-0' id='inputEmail4' placeholder='Enter Email' autoComplete='off'
